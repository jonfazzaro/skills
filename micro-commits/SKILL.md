...
|-------|--------|---------|
| New behavior (green spec) | `+ ` | `+ zero plus a number equals that number` |
| Design / refactor | `- r ` | `- r extract payment calculator` |
...
- After **step 12** (all expectations met, green): commit the new expectation + minimal code together.
...
```
+ zero plus a number equals that number
+ add two positive numbers
- r extract addition into calculator class
